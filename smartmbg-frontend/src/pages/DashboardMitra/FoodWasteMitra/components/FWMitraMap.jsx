        ...
        {selectedItem ? (
          <>
            <div className="detail-school-info" style={{display:'flex', gap:'12px', marginBottom:'20px'}}>
              <NgrokImage src={selectedItem.image_path ? `https://5e86-182-8-67-131.ngrok-free.app/api/file/${selectedItem.image_path.replace('storage/', '')}` : bentoImg} alt={selectedItem.lokasi} style={{width:'60px', height:'60px', borderRadius:'8px', objectFit:'cover'}} />
              <div>
