        ...
        {selectedItem ? (
          <>
            <div className="detail-school-info" style={{display:'flex', gap:'12px', marginBottom:'20px'}}>
              <img src={selectedItem.image_path ? `https://smart-mbg-coral.vercel.app/${selectedItem.image_path}` : bentoImg} alt={selectedItem.lokasi} style={{width:'60px', height:'60px', borderRadius:'8px', objectFit:'cover'}} />
              <div>
