...
const LaporanMitra = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://smart-mbg-coral.vercel.app/api/laporan-mitra');
      ...
      try {
        const responseFW = await axios.get('https://smart-mbg-coral.vercel.app/api/sppg/food-wastes');
  ...
  const handleDelete = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`https://smart-mbg-coral.vercel.app/api/laporan-mitra/${id}`);
