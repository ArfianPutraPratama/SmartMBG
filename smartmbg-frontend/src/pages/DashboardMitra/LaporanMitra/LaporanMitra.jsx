...
const LaporanMitra = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://9c6d-182-8-68-206.ngrok-free.app/api/laporan-mitra');
      ...
      try {
        const responseFW = await axios.get('https://9c6d-182-8-68-206.ngrok-free.app/api/sppg/food-wastes');
      ...
      // Process for chart
      generateChartData(data, filterDays);
  ...
  const handleDelete = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`https://9c6d-182-8-68-206.ngrok-free.app/api/laporan-mitra/${id}`);
          ...
          <div className="chart-section">
            <div className="chart-header">
              <div className="chart-title">
                ...
                <p>Akumulasi panen harian dalam {filterDays} hari terakhir</p>
              </div>
              <select 
