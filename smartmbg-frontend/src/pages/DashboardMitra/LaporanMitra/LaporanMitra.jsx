...
const LaporanMitra = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://violet-cups-wish.loca.lt/api/laporan-mitra');
      ...
      try {
        const responseFW = await axios.get('https://violet-cups-wish.loca.lt/api/sppg/food-wastes');
  ...
  const handleDelete = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`https://violet-cups-wish.loca.lt/api/laporan-mitra/${id}`);
