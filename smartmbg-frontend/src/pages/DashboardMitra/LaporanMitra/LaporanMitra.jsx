...
const LaporanMitra = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('https://a5a1-182-8-68-206.ngrok-free.app/api/laporan-mitra');
      ...
      try {
        const responseFW = await axios.get('https://a5a1-182-8-68-206.ngrok-free.app/api/sppg/food-wastes');
  ...
  const handleDelete = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.delete(`https://a5a1-182-8-68-206.ngrok-free.app/api/laporan-mitra/${id}`);
