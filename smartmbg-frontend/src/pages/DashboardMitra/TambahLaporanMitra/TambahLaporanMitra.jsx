...
const TambahLaporanMitra = () => {
  ...
  useEffect(() => {
    ...
    setBatchId(`B-${dateStr}-${randomSuffix}`);
    setTanggal(dateStr);

    // Fetch Gudang capacity
    const fetchGudang = async () => {
      try {
        const response = await axios.get('https://9c6d-182-8-68-206.ngrok-free.app/api/gudang-mitra');
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://9c6d-182-8-68-206.ngrok-free.app/api/laporan-mitra', payload);
      if (response.status === 201) {
        Swal.fire({
          icon: 'success',
          title: 'Berhasil!',
          text: 'Laporan operasional berhasil disimpan.',
          confirmButtonColor: '#1a5d2c'
        }).then(() => {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Gagal',
        text: 'Terjadi kesalahan saat menyimpan laporan. Pastikan data valid.',
        confirmButtonColor: '#1a5d2c'
      });
    }
  };
  ...
  const handleUpdateMaxCapacity = async (newMax) => {
    ...
    try {
      await axios.post('https://9c6d-182-8-68-206.ngrok-free.app/api/gudang-mitra/capacity', {
  ...
  const handleResetGudang = async () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await axios.post('https://9c6d-182-8-68-206.ngrok-free.app/api/gudang-mitra/reset');
          setBaseFilledTon(0);
          Swal.fire({
            icon: 'success',
            title: 'Direset!',
    ...
    <div className="dashboard-layout">
      ...
      <main className="dashboard-main">
        <header className="dashboard-topbar">
          <div className="topbar-title">Tambah Laporan</div>
            ...
            <div className="form-card">
              <div className="form-card-header">
                <div className="form-card-title">
                  ...
                  <p>Silakan lengkapi formulir di bawah ini untuk mencatat aktivitas harian.</p>
                </div>
          ...
          <div className="tambah-laporan-right">
            ...
            <div className="side-card">
              ...
              <div className="summary-row">
                ...
                <span className="value">B-2024-05-24-001</span>
              </div>
...
export default TambahLaporanMitra;
