    ...
    const fetchActivities = async () => {
      try {
        const [fwRes, laporanRes] = await Promise.all([
          axios.get('https://a5a1-182-8-68-206.ngrok-free.app/api/sppg/food-wastes').catch(() => ({ data: [] })),
          axios.get('https://a5a1-182-8-68-206.ngrok-free.app/api/laporan-mitra').catch(() => ({ data: [] }))
        ]);
