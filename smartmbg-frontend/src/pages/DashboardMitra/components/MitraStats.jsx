...
const MitraStats = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const foodWastesRes = await axios.get('https://smartmbg-backend-git-main-fians-projects-ae029f5d.vercel.app/api/sppg/food-wastes');
        ...
        try {
          const laporanRes = await axios.get('https://smartmbg-backend-git-main-fians-projects-ae029f5d.vercel.app/api/laporan-mitra');
