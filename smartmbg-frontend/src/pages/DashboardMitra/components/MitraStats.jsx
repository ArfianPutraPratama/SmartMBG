...
const MitraStats = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const foodWastesRes = await axios.get('https://a5a1-182-8-68-206.ngrok-free.app/api/sppg/food-wastes');
        ...
        try {
          const laporanRes = await axios.get('https://a5a1-182-8-68-206.ngrok-free.app/api/laporan-mitra');
