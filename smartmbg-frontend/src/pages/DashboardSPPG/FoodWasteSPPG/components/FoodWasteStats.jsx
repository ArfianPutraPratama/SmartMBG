  ...
  return (
    <div className="fw-stats-grid">
      <div className="fw-stat-card">
        ...
        <div className="fw-stat-value green">4.500</div>
      ...
      <div className="fw-stat-card">
        ...
        <div className="fw-stat-value green">15</div>
        <div className="fw-stat-footer positive">
      ...
      <div className="fw-stat-card">
        <div className="fw-stat-title">Food Waste</div>
        <div className="fw-stat-value red">72 Kg</div>
      ...
      <div className="fw-stat-card">
        <div className="fw-stat-title">Rating MBG</div>
        <div className="fw-stat-value">4.8 <span className="star-icon">★</span></div>
        <div className="fw-stat-footer neutral">
          Berdasarkan 1.2k Ulasan
        </div>
      </div>
    </div>
  );
